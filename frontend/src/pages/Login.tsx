  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-[#fbfbfa]">
      <div className="relative p-12 flex flex-col justify-between bg-neutral-900 text-white bg-[url('https://images.unsplash.com/photo-1512820790803-83ca734da794')] bg-cover bg-center">
        ...
        <div className="relative z-10 font-serif text-2xl font-semibold">
          BookVerse
        </div>
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-neutral-300 font-light">
            Join our community of curated readers and explorers.
          </p>
        </div>
        <div className="relative z-10 text-xs text-neutral-400">
          © 2026 BookVerse Editorial House.
        </div>
      </div>
        ...
        <form onSubmit={handleLogin} className="w-full max-w-sm space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border-b border-neutral-300 py-2 focus:border-neutral-950 outline-none bg-transparent"
          ...
          <button
            type="submit"
            className="w-full bg-[#2c3e35] hover:bg-emerald-950 text-white py-3 uppercase tracking-widest text-xs font-semibold transition"
          >
            Sign In
          </button>
